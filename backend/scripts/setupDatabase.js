...
const setupDatabase = async () => {
  try {
    ...
    const instructors = await User.insertMany([
      {
        name: 'Instructor One',      
        email: 'instructor1@ideamagix.com',
      ...
      {
        name: 'Instructor Two',
        email: 'instructor2@ideamagix.com',
        password: hashedInstructorPass,
        role: 'instructor',
        phone: '9876543211',
    ...
    console.log('👨‍💼 Admin: admin@ideamagix.com / admin123');
    console.log('👨‍🏫 Instructor: instructor1@ideamagix.com / instructor123');
    console.log('👨‍🏫 Instructor: instructor2@ideamagix.com / instructor123');
